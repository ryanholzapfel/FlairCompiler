...
parse_table = {   (NonTerminal.ACTUALS, TokenType.BOOLEAN): [   NonTerminal.NONEMPTYACTUALS],
    ...
    (NonTerminal.LITERAL, TokenType.BOOLEAN): [TokenType.BOOLEAN, Ast_Type.make_boolean],
    (NonTerminal.LITERAL, TokenType.NUMBER): [TokenType.NUMBER, Ast_Type.make_integer],
    ...
    (NonTerminal.SIMPLEEXPR, TokenType.BOOLEAN): [   NonTerminal.TERM,
                                                         NonTerminal.SEPRIME, Ast_Type.make_simpleexpr],
